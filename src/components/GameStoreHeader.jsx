         ...
         <nav>
            <ul>
               ...
               <g transform="translate(0 -56)">
                  ...
                  <text id="積分商店" transform="translate(125 145)" fill="#faf3e2" font-size="70" font-family="PingFangTC-Semibold, PingFang TC" font-weight="600"><tspan x="0" y="0">積分商店</tspan></text>
               </g>
               </svg>
               </li>
               ...
               <g id="我的積分Btn" transform="translate(-1355 -97)">
                  <rect id="Rectangle_117" data-name="Rectangle 117" width="348" height="87" rx="20" transform="translate(1355 97)" fill="#fff"/>
                  <text id="我的積分" transform="translate(1477 161)" font-size="50" font-family="PingFangTC-Semibold, PingFang TC" font-weight="600"><tspan x="0" y="0">我的積分</tspan></text>
