...
import "../css/GameRoomFirstPage_style.css";

let GameRoomFirstPage = (props) => {
   let test = () => {
      ...
      <div id="container" className="row" style={{display:props.show}}>
         <div className="col-lg-12">
            ...
            <div id="centerSide">
               <ul>
            <li id="licard1">
            <svg width="240" height="230" viewBox="0 0 373 336">
            <defs>
            ...
            <g id="card1" transform="translate(-96 -287)">
               ...
               <g id="light" transform="translate(79.5 31.989)">
...
export default GameRoomFirstPage;