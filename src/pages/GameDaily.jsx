...
class GameDaily extends Component {
   ...
   // constructor(props) {
   //    super(props);
   //    this.linkbt = this.linkbt.bind(this);
   //  }
   ...
   linkbt =  () => {
      ...
      // this.setState();
      // await Axios.popup(e.this.light)
         ...
         <div className="row">
            <div className="col-lg-12">
               ...
               <svg width="1020" height="500"
                  ...
                  <g id="關卡" clip-path="url(#clip-關卡)">
                     <rect width="1920" height="1080" fill="#eddbbe" />
                     <g id="選擇關卡">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_102)">
                           <path id="Rectangle_102-2" data-name="Rectangle 102"
                              d="M58,0H442a59,59,0,0,1,59,59V85a59,59,0,0,1-59,59H59A59,59,0,0,1,0,85V58A58,58,0,0,1,58,0Z"
                              transform="translate(49 49)" fill="#3e88a8" />
                        </g>
                        <text id="選擇關卡-2" data-name="選擇關卡" transform="translate(113 157)" fill="#fff" font-size="100"
                           font-family="PingFangTC-Semibold, PingFang TC" font-weight="600">
                           <tspan x="0" y="0">選擇關卡</tspan>
                        </text>
                     </g>


                     <a href="javascript:void(0)" onClick={this.linkbt}>
                        <g id="關卡1">
                           <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_107)">
                              <rect id="Rectangle_107-2" data-name="Rectangle 107" width="311" height="311" rx="30"
                                 transform="translate(227 265)" fill="#fff" />
                           </g>
                           <text id="_1" data-name="1" transform="translate(327 475)" font-size="200"
                     ...
                     <g id="關卡2">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_108)">
                           <rect id="Rectangle_108-2" data-name="Rectangle 108" width="311" height="311" rx="30"
                              transform="translate(605 265)" fill="#fff" />
                        </g>
                        <text id="_2" data-name="2" transform="translate(705 475)" font-size="200"
                           font-family="Helvetica-Bold, Helvetica" font-weight="700">
                     ...
                     <g id="關卡3">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_109)">
                           <rect id="Rectangle_109-2" data-name="Rectangle 109" width="311" height="311" rx="30"
                              transform="translate(983 265)" fill="#fff" />
                        </g>
                        <text id="_3" data-name="3" transform="translate(1083 475)" font-size="200"
                           font-family="Helvetica-Bold, Helvetica" font-weight="700">
                     ...
                     <g id="關卡4">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_110)">
                           <rect id="Rectangle_110-2" data-name="Rectangle 110" width="311" height="311" rx="30"
                              transform="translate(1361 265)" fill="#fff" />
                        </g>
                        <text id="_4" data-name="4" transform="translate(1461 475)" font-size="200"
                           font-family="Helvetica-Bold, Helvetica" font-weight="700">
                     ...
                     <g id="關卡5">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_111)">
                           <rect id="Rectangle_111-2" data-name="Rectangle 111" width="311" height="311" rx="30"
                              transform="translate(227 650)" fill="#fff" />
                        </g>
                        <text id="_5" data-name="5" transform="translate(327 860)" font-size="200"
                           font-family="Helvetica-Bold, Helvetica" font-weight="700">
                     ...
                     <g id="關卡6">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_112)">
                           <rect id="Rectangle_112-2" data-name="Rectangle 112" width="311" height="311" rx="30"
                              transform="translate(605 650)" fill="#fff" />
                        </g>
                        <text id="_6" data-name="6" transform="translate(705 860)" font-size="200"
                           font-family="Helvetica-Bold, Helvetica" font-weight="700">
                     ...
                     <g id="關卡7">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_113)">
                           <rect id="Rectangle_113-2" data-name="Rectangle 113" width="311" height="311" rx="30"
                              transform="translate(983 650)" fill="#fff" />
                        </g>
                        <text id="_7" data-name="7" transform="translate(1083 860)" font-size="200"
                           font-family="Helvetica-Bold, Helvetica" font-weight="700">
                     ...
                     <g id="關卡8">
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Rectangle_114)">
                           <rect id="Rectangle_114-2" data-name="Rectangle 114" width="311" height="311" rx="30"
                              transform="translate(1361 650)" fill="#fff" />
                        </g>
                        <text id="_8" data-name="8" transform="translate(1461 860)" font-size="200"
                           font-family="Helvetica-Bold, Helvetica" font-weight="700">
               ...
               <g id="light">
                  <svg xmlns="http://www.w3.org/2000/svg" width="700" height="345" viewBox="0 0 1033 845">
                     <g id="關卡條件" transform="translate(-484 -157)">
                        ...
                        <text id="關卡條件-2" data-name="關卡條件" transform="translate(526 274)" fill="#520707" font-size="80"
                           font-family="PingFangTC-Semibold, PingFang TC" font-weight="600">
                           <tspan x="0" y="0">關卡條件</tspan>
                        </text>
                        <line id="Line_41" data-name="Line 41" x2="1032" transform="translate(485 314.5)" fill="none" stroke="#707070"
                           stroke-width="5" />
                        <text id="時間:" transform="translate(581 517)" fill="#520707" font-size="80"
                           font-family="PingFangTC-Semibold, PingFang TC" font-weight="600">
                           <tspan x="0" y="0">時間</tspan>
                           <tspan y="0" font-family="Helvetica-Bold, Helvetica" font-weight="700">:</tspan>
                        </text>
                        <text id="交易天數:" transform="translate(574 712)" fill="#520707" font-size="80"
                           font-family="PingFangTC-Semibold, PingFang TC" font-weight="600">
                        ...
                        <g id="進入關卡_按鈕" data-name="進入關卡 按鈕" transform="translate(400 41)">
                           ...
                           <text id="進入關卡" transform="translate(615 878)" fill="#fff" font-size="100"
                              font-family="'\.PingFangTC-Semibold', '\.PingFang TC'" font-weight="600">
